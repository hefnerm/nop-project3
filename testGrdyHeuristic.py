...
for instance in [7, 9, 10]:
	...
	print("\ninstance ", instance, ", required decrease 0.9999")
	
	x, maxIndex, maxVal = grdy_heuristic.greedy_heuristic(trainDic, newPowerDic, T_m, PL, ST, passConOrd, timeHorizonMin, instance, 0.9999)